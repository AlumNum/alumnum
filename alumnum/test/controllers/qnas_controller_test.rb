...
class QnasControllerTest < ActionController::TestCase
  ...
  test "should create qna" do
    assert_difference('Qna.count') do
      post :create, qna: { question_id: @qna.question_id, response: @qna.response, user_id: @qna.user_id }
    end
  ...
  test "should update qna" do
    patch :update, id: @qna, qna: { question_id: @qna.question_id, response: @qna.response, user_id: @qna.user_id }
    assert_redirected_to qna_path(assigns(:qna))
  end
